...
class BotonWindows(Boton):
    def renderizar(self):
        print("Botón en estilo Windows...")
class BotonMac(Boton):
    def renderizar(self):
        print("Botón en estilo Mac...")
        

class MenuWindows(Menu):
    def renderizar(self):
        print("Menú en estilo Windows...")
class MenuMac(Menu):
    def renderizar(self):
        print("Menú en estilo Mac...")


class CheckBoxWindows(CheckBox):
    def renderizar(self):
        print("CheckBox en estilo Windows...")
class CheckBoxMac(CheckBox):
    def renderizar(self):
        print("CheckBox en estilo Mac...")
